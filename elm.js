...
Elm.Hakoppy = Elm.Hakoppy || {};
Elm.Hakoppy.make = function (_elm) {
   "use strict";
   _elm.Hakoppy = _elm.Hakoppy || {};
   if (_elm.Hakoppy.values)
   return _elm.Hakoppy.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var initInputs = {_: {}
                    ...
                    ,keys: false
                    ,prevKeys: false};
   var keyPressured = function (s) {
      return {_: {}
             ,delta: s.delta
             ,keys: s.keys};
   };
   var keyPressure = F2(function (a,
   s) {
      return {_: {}
             ,delta: a.delta
             ,keys: a.keys
   ...
   var hakoRot = function (vy) {
      return vy * 0.1;
   };
   var collideObj = F2(function (o1,
   o2) {
      return function () {
         var o2t = o2.y + o2.h;
         var o2b = o2.y;
   ...
   var collide = F3(function (pipes,
   area,
   hako) {
      return function () {
         var collided = A2($List.any,
         collideObj(hako),
         pipes) || $Basics.not(A2(collideObj,
         hako,
         area));
         return $Basics.not(hako.dead) && collided ? _U.replace([["dead"
                                                                 ,true]
                                                                ,["color"
                                                                 ,hako.deadColor]
                                                                ,["vy",0.0]],
   ...
   var isInside = function (pipe) {
      return _U.cmp(0 - pipe.w,
      pipe.x) < 0;
   };
   var upperGround = F2(function (g,
   o) {
      return _U.replace([["y"
                         ,_U.cmp(o.y,
                         g.y + g.h) < 0 ? g.y + g.h : o.y]],
      o);
   });
   ...
   var updatePipe = F2(function (dt,
   pipe) {
      return physics(dt)(pipe);
   });
   var updatePipes = F2(function (dt,
   pipes) {
   ...
   var hop = F2(function (keys,
   hako) {
      return keys && ($Basics.not(hako.hopping) && $Basics.not(hako.dead)) ? _U.replace([["vy"
                                                                                         ,2]
                                                                                        ,["hopping"
                                                                                         ,true]],
      hako) : $Basics.not(keys) && hako.hopping ? _U.replace([["hopping"
                                                              ,false]],
      hako) : hako;
   });
   var updateHako = F3(function (inputs,
   ground,
   hako) {
      return physics(inputs.delta)(hop(inputs.keys)(gravity(inputs.delta)(upperGround(ground)(hako))));
   });
   var throughPipe = F2(function (pipes,
   hako) {
      return function () {
         switch (pipes.ctor)
         {case "::": return function () {
                 var throughed = $Basics.not(pipes._0.throughed) && _U.cmp(hako.x,
                 pipes._0.x) > 0;
                 var p$ = _U.replace([["throughed"
                                      ,pipes._0.throughed || throughed]],
                 pipes._0);
                 var $ = A2(throughPipe,
                 pipes._1,
                 hako),
   ...
   var updateInit = F2(function (inputs,
   model) {
      return inputs.keys ? _U.replace([["state"
                                       ,Running]
                                      ,["hako"
                                       ,A2(hop,true,model.hako)]],
      model) : model;
   });
   var Init = {ctor: "Init"};
   var ThroughObj = F2(function (a,
   b) {
      return _U.insert("throughed",
      a,
      b);
   });
   var HakoObj = F4(function (a,
   b,
   c,
   d) {
      return _U.insert("deadColor",
      c,
      _U.insert("dead",
      b,
      _U.insert("hopping",a,d)));
   });
   var MovingObj = F3(function (a,
   b,
   c) {
      return _U.insert("vy",
      b,
   ...
   var initHako = {_: {}
                  ...
                  ,y: imagH / 2};
   var imagW = 100;
   var initPipe = function (dr) {
      return function () {
         var pipeD = 15;
         var centerY = $Basics.toFloat(dr) * 2.0 + imagH / 2;
         var p = {_: {}
                 ,color: A3($Color.rgb,0,255,0)
                 ,h: 0
                 ,throughed: false
                 ,vx: -0.8
                 ,vy: 0
                 ...
                 ,x: imagW
                 ,y: 0};
         return _L.fromArray([_U.replace([["y"
                                          ,0]
                                         ,["h",centerY - pipeD]
                                         ,["throughed",true]],
                             p)
   ...
   var generatePipes = F2(function (gen,
   rand) {
      return _U.cmp(gen,
      0) < 0 ? initPipe(rand) : _L.fromArray([]);
   });
   var initArea = {_: {}
                  ,color: A3($Color.rgb,
                  174,
   ...
   var initModel = {_: {}
                   ...
                   ,state: Init};
   var updateRunning = F2(function (inputs,
   model) {
      return function () {
         ...
         rand = $._0,
         seed$ = $._1;
         var gen$ = model.gen - inputs.delta;
         var pipes$ = $Basics.not(model.hako.dead) ? A2($Basics._op["++"],
         A2(updatePipes,
         inputs.delta,
         model.pipes),
         A2(generatePipes,
         ...
         var model$ = _U.replace([["hako"
                                 ...
                                 ,["gen"
                                  ...
                                  0) < 0 ? initGen : gen$]
                                 ,["score"
                                  ,model.score + scoreAcc]
                                 ,["seed",seed$]],
         model);
         return model$.hako.dead && inputs.keys ? initModel : model$;
      }();
   });
   var update = F2(function (inputs,
   model) {
      return function () {
         var _v3 = model.state;
         switch (_v3.ctor)
         {case "Init":
            return A2(updateInit,
              inputs,
              model);
            case "Running":
         ...
         return function () {
            ...
            {case "_Tuple2":
               return function () {
                    ...
                    sw = $._0,
                    sh = $._1;
                    var s = A2($Basics.min,sw,sh);
                    var viewObject = function (o) {
                       return $Graphics$Collage.scale(s)($Graphics$Collage.move({ctor: "_Tuple2"
                                                                                ,_0: s * (o.x + o.w / 2 - imagW / 2)
                                                                                ,_1: s * (o.y + o.h / 2 - imagH / 2)})($Graphics$Collage.filled(o.color)(A2($Graphics$Collage.rect,
                       o.w,
                       o.h))));
                    };
                    var scoreT = function () {
                       ...
                       {case "Init":
                          ...
                          case "Running":
                          return $Graphics$Element.show(_v5.score);}
                       _U.badCase($moduleName,
                       "between lines 342 and 346");
                    }();
                    var msg = function () {
                       var _v11 = _v5.state;
                       switch (_v11.ctor)
                       {case "Init":
                          return $Graphics$Element.show("Click to Start");
                          case "Running":
                          return $Graphics$Element.empty;}
                       _U.badCase($moduleName,
                       "between lines 337 and 341");
                    }();
                    var sph = (h - s * imagH) / 2;
                    var spw = (w - s * imagW) / 2;
                    var viewHako = function (hako) {
                       return $Graphics$Collage.rotate(hakoRot(hako.vy))(viewObject(hako));
                    };
                    return A3($Graphics$Collage.collage,
                    _v4._0,
                    _v4._1,
                    A2($Basics._op["++"],
                    _L.fromArray([viewObject(_v5.area)
                                 ,viewObject(_v5.ground)]),
                    A2($Basics._op["++"],
                    A2($List.map,
                    viewObject,
                    _v5.pipes),
                    _L.fromArray([viewHako(_v5.hako)
                                 ,$Graphics$Collage.toForm(scoreT)
                                 ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                         ,_0: 0
                                                         ,_1: 30})($Graphics$Collage.toForm(msg))
                                 ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                         ,_0: spw / 2 - w / 2
                                 ...
                                 ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                         ,_0: 0
                                                         ,_1: sph / 2 - h / 2})($Graphics$Collage.filled($Color.black)(A2($Graphics$Collage.rect,
                                 w,
                                 sph)))
                                 ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                         ,_0: 0
                                                         ,_1: (0 - sph) / 2 + h / 2})($Graphics$Collage.filled($Color.black)(A2($Graphics$Collage.rect,
                                 w,
                                 sph)))]))));
                 }();}
            _U.badCase($moduleName,
            "between lines 313 and 367");
         }();
      }();
   });
   ...
   initModel,
   input));
   _elm.Hakoppy.values = {_op: _op
                         ,imagW: imagW
                         ,imagH: imagH
                         ,Object: Object
                         ,MovingObj: MovingObj
                         ,HakoObj: HakoObj
                         ,ThroughObj: ThroughObj
                         ,Init: Init
                         ,Running: Running
                         ,Model: Model
                         ,Inputs: Inputs
                         ...
                         ,throughPipe: throughPipe
                         ,update: update
                         ,updateHako: updateHako
                         ,hop: hop
                         ,gravity: gravity
                         ,physics: physics
